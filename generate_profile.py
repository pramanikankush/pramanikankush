...
INFO = [
    ...
    ("__blank__", "", ""),
    ("__section__", "~/reach", ""),
    ("Web",      "ankush-portfolio-colr.vercel.app", "accent"),
    ("In",       "linkedin.com/in/ankush-pramanik-853565259", "accent"),
    ("Mail",     "ankushpramanik@gmail.com", "accent"),
]
